 ...
 */
public interface ProveniceService extends IService<ProveniceEntity> {

	List<ProveniceEntity> getProveniceList();
	
	List<CityEntity> getCityList(CityEntity query);
	
	List<AreaEntity> getAreaList(AreaEntity query);
